...
\hypersetup{
  pdftitle={The Yeshuan Sayings},
  pdfauthor={Rez Khan},
  pdfsubject={81 sayings from the Yeshuan path},
  pdfkeywords={Rez Khan, The Living Way, Yeshua, sayings, gnosis},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[CO]{\scshape\small The Yeshuan Sayings} 
...
\begin{titlepage}
    \centering
    \vspace*{1.5cm}
    {\Huge \textsc{The Scroll of}\\ \textsc{The Yeshuan Sayings}} \\
    \vspace{0.5cm}
    {\large \textit{81 Sayings from the Yeshuan Path}} \\
    \vspace{2cm}
...
\noindent\textit{The gospel line ``I am the way, the truth, and the life'' (John 14:6) is often heard as a claim about a figure alone; here it also names the \textbf{sense of being}---the ``I am'' beneath the story. \textbf{To investigate that presence} (``What is this I?'' before name and role) \textbf{is the path}: way, truth, and life are not three outward tickets but what opens in that inquiry. In Advaita Vedānta, a parallel discipline is \emph{ātma-vichāra} (self-inquiry) and the recognition that the witness-self (\emph{ātman}) is not other than \emph{Brahman}---different idiom, one movement toward what was never absent.}
