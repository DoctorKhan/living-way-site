...
\begin{titlepage}
    ...
    {\large \textit{The 81 Sayings of Yeshua the Living One}} \\
	    \vspace{2cm}
	    \textbf{A Tao of the Inner Way for the Children of Light} \\
    \vspace{0.5cm}
...
\textbf{The Bridal Chamber:} A Wisdom Gospel metaphor for the state of union where duality (male/female, human/divine, inner/outer) is dissolved and the soul is reunited with the Spirit.
